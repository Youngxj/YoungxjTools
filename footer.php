...
<footer class="footer text-center">
	<div>
		Copyright <a href="http://www.youngxj.cn" target="_blank"><?php echo $tools_settings['copyright'];?></a> 2018 - <?php echo $tools_settings['icp'];?>  <a href="../log.php" target="_blank">时间轴</a> <a href="../about.php" target="_blank">关于</a>
	</div>
	<div class="hitokoto">
