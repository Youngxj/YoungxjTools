      ...
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form action="tools_up.php?domain=update" method="post" class="form-horizontal" name="setting">
            ...
            <div class="form-group">
              <label for="" class="col-sm-3 col-md-3 col-lg-2 control-label">工具描述：</label>
              <div class="col-sm-9 col-md-9 col-lg-10">
                <div class="row">
                  <div class="col-md-6">
                    <div class="input-group input-group-sm">
                      <span class="input-group-addon"><i class="fa fa-newspaper-o"></i></span>
                      <input type="text" placeholder="工具描述" class="form-control" name="explains" id="explains" value="<?php echo $tools_up_id['explains'];?>">
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="input-group input-group-sm">
                      ...
                      <input type="text" placeholder="类别" class="form-control" name="tools_type" id="tools_type" value="<?php echo $tools_up_id['tools_type'];?>">
                    </div>
                  </div>
                </div>
              </div>
