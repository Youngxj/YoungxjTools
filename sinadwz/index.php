      ...
      <h5 class="text-right"><small><?php echo $explains;?></small></h5>
			<div class="form-group" id="input-wrap">
				...
				<div class="input-group">
					<input type="text" class="form-control" placeholder="请填写长网址">
...
<script type="text/javascript" src="sinadwz.php?rand=<?php echo md5(md5((int)(time()/10)).encryption(1));?>&_=<?php echo randomFloat(1, 99999999);?>"></script>
